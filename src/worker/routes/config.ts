...
const CONFIG_FIELDS = ["aiProvider", "aiModel", "aiBaseUrl", "aiApiKey", "aiMaxTokens", "aiMaxContextChars", "aiSystemPrompt", "webhookUrl", "webhookEnabled", "webhookTitle", "webhookApiKey", "webhookChannels", "aiPresets", "aiCustomProviders", "aiMaxRetries", "aiThinking", "newsnowBaseUrl", "searchBaseUrl", "searchToken", "searchEngine", "allowlist"] as const;
