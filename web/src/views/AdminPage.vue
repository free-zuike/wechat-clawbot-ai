...
async function handleLoadConfig() {
  ...
  try {
    ...
    config.aiMaxTokens = d.aiMaxTokens || 1024;     config.aiMaxContextChars = d.aiMaxContextChars || 20000;     config.aiSystemPrompt = d.aiSystemPrompt || "";
    config.aiMaxRetries = d.aiMaxRetries ?? 2;
    config.aiThinking = d.aiThinking || false;
    config.newsnowBaseUrl = d.newsnowBaseUrl || "";
    config.searchBaseUrl = d.searchBaseUrl || "";
    config.searchToken = d.searchToken || "";
    config.searchEngine = d.searchEngine || "";
    config.allowlist = d.allowlist || "";
